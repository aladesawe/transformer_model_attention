...
class PositionalEmbedding(tf.keras.layers.Layer):
    """
    Positional embedding layer. Assume tokenized input, transform into embedding and returns positional-encoded output.
    """
    ...
    def get_config(self):
        # to make saving and loading a model using custom layer possible
